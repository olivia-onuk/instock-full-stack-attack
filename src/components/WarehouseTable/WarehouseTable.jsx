...
function WarehouseTable() {
  ...
  useEffect(() => {
    const getWarehouses = async () => {
      const resp = await fetchWarehouses(sortConfig.key, sortConfig.order);
      setWarehouses(resp);
    };
    getWarehouses();
  }, [sortConfig]);
      ...
      <div className="warehouse-tablet-header">
        <span className="warehouse-tablet-label">
          ...
          <img
            src={sortIcon}
            alt="sort"
            className="warehouse-tablet-icon"
      ...
      >
        <div className="delete-modal__content">
          <div className="delete-modal__top">
            <div className="delete-modal__close" onClick={handleCloseModal}>
